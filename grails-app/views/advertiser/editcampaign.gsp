                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <g:select class="span1" name="start_hour" from="${hourList}" value="${campaign.startDatetime.hours}"/> :
                            <g:select class="span1" name="start_min" from="${['00', '15', '30', '45']}" value="${campaign.startDatetime.minutes}"/>
                            <span class="add-on">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <g:select id="end_hour_select" class="span1" name="end_hour" from="${hourList}" value="${campaign.endDatetime.hours}"/> :
                            <g:select id="end_min_select" class="span1" name="end_min" from="${['14', '29', '44', '59']}" value="${campaign.endDatetime.minutes}"/>
                            <span class="add-on">
